...
urlpatterns = [
    ...
    path("producciones/<int:pk>/nuqueras/cuadrilla/<int:crew_pk>/eliminar/", views.NuqueraCrewDeactivateView.as_view(), name="nuquera_crew_deactivate"),
    path("producciones/<int:pk>/nuqueras/cuadrilla/<int:crew_pk>/renombrar/", views.NuqueraCrewRenameView.as_view(), name="nuquera_crew_rename"),
